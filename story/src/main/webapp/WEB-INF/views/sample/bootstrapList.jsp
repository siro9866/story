		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<form id="frm" name="frm" method="post">
					...
					<input type="hidden" name="bootstrap_id" id="bootstrap_id"/>					
				
					<div class="row">
						<div class="col-lg-6 ">
							<div class="col-lg-6 col-md-6">
								<input type="text" class="form-control input-lg" name="searchFromDt" value="${paramDto.searchFromDt }">
							</div>								
							<div class="col-lg-1 col-md-1">
								~
							</div>								
							<div class="col-lg-5 col-md-5">
								<input type="text" class="form-control input-lg" name="searchToDt" value="${paramDto.searchToDt }">
							</div>								
						</div>
						<div class="col-lg-6 ">
								...
								<c:choose>
									...
									<c:otherwise>
										<c:forEach items="${resultList }" var="result">
											<tr id="${result.bootstrap_id }">
												<td>${result.rowNum }</td>
												<td>${result.bootstrap_id }</td>
...
var detailUrl = "/sample/bootstrapDetail.do";
var formlUrl = "/sample/bootstrapForm.do";
