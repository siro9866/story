						...
						$(this)
							.children()
								.animate( {backgroundPosition:'(0px -45px)'},"fast",function(){
											...
											$(parent).css({backgroundImage: 'url(/resources/images/nav.png)'});
									});
					});
			break;
		}
...
function mMouseOver(e)
{
	...
	$(this)
		...
		.css({backgroundImage: 'url(/resources/images/nav-over.png)',cursor: 'pointer'})
...
{			
	...
	$(this)
		...
		.css({backgroundImage: 'url(/resources/images/nav.png)', cursor: ''});
}
