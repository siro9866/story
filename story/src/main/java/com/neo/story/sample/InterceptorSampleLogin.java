...
@Controller
public class InterceptorSampleLogin extends HandlerInterceptorAdapter{
	private static final Logger logger = LoggerFactory.getLogger(InterceptorSampleLogin.class);
	...
	public boolean preHandle(HttpServletRequest request,HttpServletResponse response, Object handler) throws Exception {
		...
		if(session.getAttribute("USER_ID") == null){
			...
			response.sendRedirect("/common/login/form.do");
			return false;
		}
		
		if(session.getAttribute("USER_NM") == null){
			response.sendRedirect("/common/login/infoForm.do");
			return false;
		}
