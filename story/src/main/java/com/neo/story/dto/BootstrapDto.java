package com.neo.story.dto;

public class BootstrapDto extends ComDto{
	...
	public String getBootstrap_id() {
		return bootstrap_id;
	}
	public void setBootstrap_id(String bootstrap_id) {
		this.bootstrap_id = bootstrap_id;
	}
